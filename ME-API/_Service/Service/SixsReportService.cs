...
namespace ME_API._Service.Service
{
    public class SixsReportService : ISixsReportService
    {
        ...
        public SixsReportService(IAuditRateDRepository auditRateDRepository, IAuditRateMRepository auditRateMRepository, IAuditTypeRepository auditTypeMRepository, IMesAuditOrgRepository mesAuditOrg, MapperConfiguration configMapper)
        {
