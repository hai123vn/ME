...
namespace ME_API._Service.Service
{
    public class WTTrackingReportService : IWTTrackingReportService
    {
        ...
        public WTTrackingReportService(IAuditRecMRepository repoAuditRecM, IAuditRecDRepository repoAuditRecD, IAuditTypeRepository repoAuditTypeM, IMapper mapper, MapperConfiguration configMapper, IMesAuditOrgRepository mesAuditOrg, IAuditPicDRepository repoAuditPicD)
        {
